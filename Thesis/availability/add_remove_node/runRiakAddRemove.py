...
def main():
    ...
    runAddRemoveBenchmark(cluster, remoteYcsbNodes, ipNodeToRemove, pathToWorkloadFile, pathBenchmarkResult, 
                          runtimeBenchmarkInMinutes, removeTimeInSeconds, addTimeInSeconds, amountOfThreads, targetThroughput);
