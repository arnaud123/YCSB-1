...
public class Cassandra {
	...
	private static final String IP = "172.16.33.2";
	
	public List<String> getIpsContainingDate(String keyspace, String columnFamily, String key){
	...
	private String getProcessOutput(String keyspace, String columnFamily, String key){
		try {
			String keyAsHexString = this.convertStringToHex(key);
			String threeCommands[] = {"nodetool", "-h", IP, "getendpoints", keyspace, columnFamily, keyAsHexString};
	...
	public static void main(String args[]) {
		...
		String key = args[2];
		List<String> ips = cassandra.getIpsContainingDate(keyspace, columnFamily, key);
		for(String ip : ips){
