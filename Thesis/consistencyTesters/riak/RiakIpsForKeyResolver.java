...
public class RiakIpsForKeyResolver {
	...
	public RiakIpsForKeyResolver(String ipToCheckNodesForDataItem){
	 ...
	 * with the given key. 
	 */
	public List<String> getIpsForKey(String key, int replicationFactor){
		String output = this.getOutputNodeForDataItemSearch(key, replicationFactor);
	 ...
	 */
	private String getOutputNodeForDataItemSearch(String key, int replicationFactor){
		String replicationFactorAsString = Integer.toString(replicationFactor);
		try {
	...
	public static void main(String[] args) {
		RiakIpsForKeyResolver resolver = new RiakIpsForKeyResolver("172.16.33.2");
		List<String> ips = resolver.getIpsForKey("arnaud", 3);
		for(String ip: ips)
